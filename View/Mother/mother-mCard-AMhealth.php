...
<body>
    ...
    <div class="mom-container">
        <div class="OneColumnSection"> <!--when a section has only one table, use this class-->
            <div class="MotherCardTableTitles"><h3>Auscultation & Mental Health</h3></div>
            <div class="MotherGeneralDetails">
                <table class="MotherCardTables">
                    ...
                    <tr>
                        ...
                        <td><?php echo $auscultation ?></td>
                        <td><?php echo $mental_health ?></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="updateMcardTable-popup" id="updateMcardTable-popup">
        <div class="updatePopup-content">
            <div class="updatePopup-header">
                ...
                <h2>Update Auscultation & Mental Health</h2>
            </div>
                ...
                <form action="../../Config/mother-mcardPage1.inc.php?mom_id=$mom_id" method="POST">
                    <div class="updateFormTables">
                        <table>
                            ...
                            <tr>
                                <td><input type="text" name="auscultation"></td>
                                <td><input type="text" name="mental_health"></td>
                        </table>
                    </div>
                    <input type="hidden" name="mom_id" value="<?php echo $mom_id ?>">
                    <div class="updateMcard_submit">
                        <button type="reset">Reset</button>
                        <button type="submit" name="auscultation_submit">Update</button>
                    </div>
                </form>
            </div>      
        </div>
