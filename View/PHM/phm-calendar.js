document.addEventListener('DOMContentLoaded', function() {
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    events: {
      url: 'phm-getAppointmentInfo.php?phm_id=<?php echo $_GET["phm_id"];?>',
      method: 'POST',
      format: 'json',
      failure: function() {
  ...
  function getAppointments(date) {
    ...
    const phm_id = '<?php echo $_GET["phm_id"]; ?>';
    xhr.open('GET', 'phm-scheduleManager.php?date=' + date + '&phm_id=' + phm_id, true);
