...
require_once 'dbConnection.php';
  ...
  $sql = "SELECT * FROM child_details WHERE (child_name LIKE '%$search%' 
  OR child_id LIKE '%$search%' OR mom_id LIKE '%$search%' OR child_gender LIKE '%$search%') AND phm_id='" . $_SESSION['phm_id'] . "'";
